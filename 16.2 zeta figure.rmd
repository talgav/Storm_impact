...
geom_errorbar(aes(ymin = zeta_value-zeta_sd,ymax = zeta_value+zeta_sd),width = 0.5,alpha = 0.6)+
...
#ggsave("zeta_resident_fish_2018.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("zeta_resident_fish_2018.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
...
#ggsave("zeta_resident_fish_ratio_2018.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("zeta_resident_fish_ratio_2018.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")



ggplot(data =zeta_divesity_resident[zeta_divesity_resident$year_month=="2018 b",],
       aes(x=z_order,y=zeta_ratio,color =year_month))+
  geom_line()+
  geom_point()+
  theme_classic()+
...
ggplot(data =zeta_divesity_resident,
  ...
  geom_point(data = null_zeta_decay,
            aes(x = z_order,y= mean_zeta_value),
            color = "black")+
  geom_errorbar(data = null_zeta_decay,
                aes(y = mean_zeta_value,
                    ymin = mean_zeta_value - zeta_sd,
                    ymax = mean_zeta_value + zeta_sd),
                color = "black",
                width = 0.2,alpha = 0.6)
...
ggplot(data =zeta_divesity_resident_short,
  ...
  geom_line(size=0.5)+
  geom_point(size=4)+
  geom_errorbar(aes(ymin = zeta_value-zeta_sd,ymax = zeta_value+zeta_sd),width = 0.5,alpha = 0.5)+
  theme_classic()+
  xlab("Zeta order")+
  ylab("Zeta diversity")+
  theme(text = element_text(family = "serif"),
        ...
        plot.title = element_text(size=24))+
  scale_x_continuous(limits = c(0,25), breaks = seq(0,25, by = 5))+
  scale_color_manual(values = color_op6[2],
                     name = "Year",
...
#ggsave("null_zeta_decay_2018.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("null_zeta_decay_2018.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
```
...
ggplot(data =zeta_divesity_resident_short,
  ...
  theme(text = element_text(family = "serif"),
        ...
        legend.text = element_text(size=20),
        plot.title = element_text(size=24))+
  scale_color_manual(values = color_op6[2],name = "Year",
                     labels = c("Fall 2018"))+
  geom_line(data = null_zeta_ratio,
            aes(x = z_order,y= mean_zeta_ratio),
            linetype = "dashed",
...
#ggsave("null_zeta_resident_fish_ratio_2018.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("null_zeta_resident_fish_ratio_2018.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
...
ggplot(data = ind_null_zeta_decay,aes(x=z_order,y=mean_zeta_value))+geom_line()+
  geom_point()

```
geom_errorbar(aes(ymin = zeta_value-zeta_sd,
                    ymax = zeta_value+zeta_sd),
                width = 0.5,alpha = 0.6)+
                
geom_errorbar(data = ind_null_zeta_decay,
                aes(y = mean_zeta_value,
                    ymin = mean_zeta_value - zeta_sd,
                    ymax = mean_zeta_value + zeta_sd),
                color = "#bc201c",
...
#ggsave("null_zeta_decay.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("null_zeta_decay.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
```
...
#ggsave("null_ratio.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("null_ratio.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")  
...
#ggsave("zeta_allfish_2018.pdf" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("zeta_allfish_2018.png" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
...
#ggsave("zeta_ratio_allfish_2018.pdf" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")

#ggsave("zeta_ratio_allfish_2018.png" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
