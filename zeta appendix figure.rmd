...
*In this script ill concentrate all the models and plot constructing the Zeta diversity appendix figure, thus all data from 2015*
...
resident_fish <- resident_fish %>% 
  select(site_sample,Site,year_month,Knoll,DD_X,DD_Y,Species_2015,Abundance) %>%
  group_by(site_sample,Site,year_month,Knoll,DD_X,DD_Y,Species_2015) %>% 
...
ggplot(data =zeta_divesity_resident,
  ...
  scale_color_manual(values = color_op6_l,
                     name = "Year",
                     labels = c("PreS3","PreS2","PreS1","PostS1","PostS2",
                                      "PostS3"))

#ggsave("zeta_resident_fish_2015.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")

#ggsave("zeta_resident_fish_2015.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")
...
ggplot(data =zeta_divesity_resident,
  ...
  theme(axis.text.x = element_text(size=20),
        ...
        legend.text = element_text(size=20),
        plot.title = element_text(size=24))+
    scale_color_manual(values = color_op6_l,name = "Year",
                           labels = c("PreS3","PreS2","PreS1","PostS1","PostS2",
                                      "PostS3"))
...
#ggsave("zeta_resident_fish_ratio_2015.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")

#ggsave("zeta_resident_fish_ratio_2015.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")
...
unique_sp_storm <- fish_prep %>%
  ...
  group_by(knoll_id) %>% summarise("sp_to_sample"=n_distinct(Species_2015))


null_prep <- fish_prep %>% filter(year_month == "2018 b",Status == "C") %>%  
  select(Site,year_month,knoll_id,DD_X,DD_Y,Species_2015,Abundance) %>%
  group_by(Site,year_month,knoll_id,DD_X,DD_Y,Species_2015) %>% 
  summarise(Abundance=sum(Abundance))

null_prep<-null_prep %>% group_by(Site,year_month,knoll_id,DD_X,DD_Y) %>% 
  mutate(sp_in_knoll=n_distinct(Species_2015)) %>% ungroup()
...
null<- spread(null,Species_2015,Abundance,fill = 0)
...
ggplot(data =zeta_divesity_resident,
  ...
  scale_color_manual(values = color_op6_l,
                     name = "Year",
                     labels = c("2015","2016","Fall 2018","Spring 2020","Fall 2020" ,
                                      "Spring 2021"))+
...
null_zeta_ratio<-null_zeta_ratio[1:21,]
...
ggplot(data =zeta_divesity_resident,
  ...
  theme(axis.text.x = element_text(size=20),
        ...
        plot.title = element_text(size=24))+
  scale_color_manual(values = color_op6_l,name = "Year",
                     labels = c("2015","2016","Fall 2018","Spring 2020",
...
ind_storm <- fish_prep %>%
  filter(year_month == "2020 a",Status == "C") %>% 
  group_by(knoll_id) %>% summarise("sp_to_sample"=n_distinct(Species_2015),"ind_to_sample"=sum(Abundance))

# uncount so each line is one individual

ind_null_prep <- fish_prep %>% filter(year_month == "2018 b",Status == "C") %>%  
  select(Site,year_month,knoll_id,DD_X,DD_Y,Species_2015,Abundance) %>%
  group_by(Site,year_month,knoll_id,DD_X,DD_Y,Species_2015) %>% uncount(Abundance) %>% mutate(Abundance = rep(0)) 
...
ind_null<- spread(ind_null,Species_2015,Abundance,fill = 0)
...
ggplot(data =zeta_divesity_resident_short,
  ...
  theme(text = element_text(family = "serif"),
        ...
        plot.title = element_text(size=24))+
  scale_x_continuous(limits = c(0,25), breaks = seq(0,25, by = 5))+
  scale_color_manual(values = color_op6_l[3:4],
                     name = "Year",
...
#ggsave("2015_null_zeta_decay.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")

#ggsave("2015_null_zeta_decay.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")
```
...
ggplot(data =zeta_divesity_resident_short,
  ...
  theme(text = element_text(family = "serif"),
        ...
        legend.text = element_text(size=20),
        plot.title = element_text(size=24))+
  scale_color_manual(values = color_op6_l[3:4],name = "Year",
                     labels = c("PreS1","PostS1"))+
  geom_line(data = null_zeta_ratio,
            aes(x = z_order,y= mean_zeta_ratio),
            linetype = "dashed",
...
#ggsave("2015_null_ratio.pdf" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")

#ggsave("2015_null_ratio.png" , width = 10, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")  
...
for (i in unique(all_fish$year_month)) {

# filter one year (year_month) 
      
  one_data <- all_fish %>% filter(year_month == i )
...
ggplot(data =zeta_divesity_all,
  ...
  theme(axis.text.x = element_text(size=20),
        ...
        legend.text = element_text(size=20),
        plot.title = element_text(size=24))+
  scale_x_continuous(limits = c(0,15.5), breaks = seq(0,15, by = 5))+
  scale_color_manual(values = color_op6_l,
                     name = "Year",
                     labels = c("Fall 2015","Fall 2016","Fall 2018","Spring 2020","Fall 2020" ,
                                      "Spring 2021"))

#ggsave("zeta_allfish_2015.pdf" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")

#ggsave("zeta_allfish_2015.png" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta")
...
#ggsave("zeta_ratio_allfish_2015.pdf" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")

#ggsave("zeta_ratio_allfish_2015.png" , width = 9, height = 5, dpi = 300,path = "C:\\Users\\TalG\\My Drive\\PHD\\chapter 1 strom effect\\R Scripts\\plots for ms\\zeta_appendix")
